...
cesm_temps1 <- readRDS('D:/data/cesm_forecast_temp1.rds')
cesm_salts1 <- readRDS('D:/data/cesm_forecast_salt1.rds')

# New method to use bias corrected ROMS output
get_preds <- function(data, year, date, doy,
                      month, proj, temp_output, 
                      salt_output, formula){
  nlat = 40
  nlon = 60
  ...
  bc_temps <- temp_output %>% filter(month == month &
                                                    year == year & projection == proj)
  bc_salts <- salt_output %>% filter(month == month &
                                                    year == year & projection == proj)
  grid_extent[, c(8, 9)] <- as.data.frame(RANN::nn2(bc_temps[, c('lat', 'lon')],
                                                    grid_extent[, c('lat', 'lon')],
                                                    k = 1))
  grid_extent$roms_temperature <- bc_temps$bc[c(grid_extent$nn.idx)] # Match nearest temp
  grid_extent$roms_salinity <- bc_salts$bc[c(grid_extent$nn.idx)] # Match nearest temp
  grid_extent <- grid_extent[-c(7:9)] # remove extra columns before predicting
  
  # Calculate mean temperature
  temp_filtered <- bc_temps %>% filter(lon >= -170 & lon <= -165, 
                                       lat >= 56 & lat <= 58,
                                       month >= 2 & month <= 4)
...
akp_test_preds <- get_preds(akp_egg, 2020, '2020-05-10',
                            130, 5, 'ssp126',
                            cesm_temps1, cesm_salts1,
                            egg_formula)
...
# Old function to get predictions
get_preds <- function(data, year, date, doy, 
                      start_date, end_date,
                      temp_output, salt_output,
                      list, formula){
...
df_akpegg_avg4_cesm585 <- data.frame(lat = df_akpegg4$lat, 
                                     lon = df_akpegg4$lon, 
                                     dist = df_akpegg4$dist,
                                     avg_pred = rowSums(df_akpegg4[, x])/25)
saveRDS(df_akpegg_avg4_cesm585, file = here("data", "df_akpegg_avg4_cesm585.rds"))

# Plot
windows(width = 6, height = 6, family = "serif")
grid_predict(df_akpegg_avg4_cesm585, "Forecasted Distribution 2015 - 2039 \n CESM SSP585")
dev.copy(jpeg,
         here('results/plaice_forecast',
...
df_akpegg_avg5_cesm585 <- data.frame(lat = df_akpegg5$lat, 
                                     lon = df_akpegg5$lon, 
                                     dist = df_akpegg5$dist,
                                     avg_pred = rowSums(df_akpegg5[, x])/30)
saveRDS(df_akpegg_avg5_cesm585, file = here("data", "df_akpegg_avg5_cesm585.rds"))

# Plot
windows(width = 6, height = 6, family = "serif")
grid_predict(df_akpegg_avg5_cesm585, "Forecasted Distribution 2040 - 2069 \n CESM SSP585")
dev.copy(jpeg,
         here('results/plaice_forecast',
...
df_akpegg_avg6_cesm585 <- data.frame(lat = df_akpegg6$lat, 
                                     lon = df_akpegg6$lon, 
                                     dist = df_akpegg6$dist,
                                     avg_pred = rowSums(df_akpegg6[, x])/30)
saveRDS(df_akpegg_avg6_cesm585, file = here("data", "df_akpegg_avg6_cesm585.rds"))

# Plot
windows(width = 6, height = 6, family = "serif")
grid_predict(df_akpegg_avg6_cesm585, "Forecasted Distribution 2070 - 2099 \n CESM SSP585")
dev.copy(jpeg,
         here('results/plaice_forecast',
...
df_akpegg_avg4_gfdl585 <- data.frame(lat = df_akpegg4$lat, 
                                     ...
                                     dist = df_akpegg4$dist,
                                     avg_pred = rowSums(df_akpegg4[, x])/25)
saveRDS(df_akpegg_avg4_gfdl585, file = here("data", "df_akpegg_avg4_gfdl585.rds"))

# Plot
windows(width = 6, height = 6, family = "serif")
grid_predict(df_akpegg_avg4_gfdl585, "Forecasted Distribution 2015 - 2039 \n GFDL SSP585")
dev.copy(jpeg,
         here('results/plaice_forecast',
...
df_akpegg_avg5_gfdl585 <- data.frame(lat = df_akpegg5$lat, 
                                     ...
                                     dist = df_akpegg5$dist,
                                     avg_pred = rowSums(df_akpegg5[, x])/30)
saveRDS(df_akpegg_avg5_gfdl585, file = here("data", "df_akpegg_avg5_gfdl585.rds"))

# Plot
windows(width = 6, height = 6, family = "serif")
grid_predict(df_akpegg_avg5_gfdl585, "Forecasted Distribution 2040 - 2069 \n GFDL SSP585")
dev.copy(jpeg,
         here('results/plaice_forecast',
...
df_akpegg_avg6_gfdl585 <- data.frame(lat = df_akpegg6$lat, 
                                     ...
                                     dist = df_akpegg6$dist,
                                     avg_pred = rowSums(df_akpegg6[, x])/30)
saveRDS(df_akpegg_avg6_gfdl585, file = here("data", "df_akpegg_avg6_gfdl585.rds"))

# Plot
windows(width = 6, height = 6, family = "serif")
grid_predict(df_akpegg_avg6_gfdl585, "Forecasted Distribution 2070 - 2099 \n GFDL SSP585")
dev.copy(jpeg,
         here('results/plaice_forecast',
...
df_akpegg_avg4_miroc585 <- data.frame(lat = df_akpegg4$lat, 
                                      ...
                                      dist = df_akpegg4$dist,
                                      avg_pred = rowSums(df_akpegg4[, x])/25)
saveRDS(df_akpegg_avg4_miroc585, file = here("data", "df_akpegg_avg4_miroc585.rds"))

# Plot
windows(width = 6, height = 6, family = "serif")
grid_predict(df_akpegg_avg4_miroc585, "Forecasted Distribution 2015 - 2039 \n MIROC SSP585")
dev.copy(jpeg,
         here('results/plaice_forecast',
...
df_akpegg_avg5_miroc585 <- data.frame(lat = df_akpegg5$lat, 
                                      ...
                                      dist = df_akpegg5$dist,
                                      avg_pred = rowSums(df_akpegg5[, x])/30)
saveRDS(df_akpegg_avg5_miroc585, file = here("data", "df_akpegg_avg5_miroc585.rds"))

# Plot
windows(width = 6, height = 6, family = "serif")
grid_predict(df_akpegg_avg5_miroc585, "Forecasted Distribution 2040 - 2069 \n MIROC SSP585")
dev.copy(jpeg,
         here('results/plaice_forecast',
...
df_akpegg_avg6_miroc585 <- data.frame(lat = df_akpegg6$lat, 
                                      ...
                                      dist = df_akpegg6$dist,
                                      avg_pred = rowSums(df_akpegg6[, x])/30)
saveRDS(df_akpegg_avg6_miroc585, file = here("data", "df_akpegg_avg6_miroc585.rds"))

# Plot
windows(width = 6, height = 6, family = "serif")
grid_predict(df_akpegg_avg6_miroc585, "Forecasted Distribution 2070 - 2099 \n MIROC SSP585")
dev.copy(jpeg,
         here('results/plaice_forecast',
...
df_akplarvae_avg4_cesm585 <- data.frame(lat = df_akplarvae4$lat, 
                                        ...
                                        dist = df_akplarvae4$dist,
                                        avg_pred = rowSums(df_akplarvae4[, x])/25)
saveRDS(df_akplarvae_avg4_cesm585, file = here("data", "df_akplarvae_avg4_cesm585.rds"))

# Plot
windows(width = 6, height = 6, family = "serif")
grid_predict(df_akplarvae_avg4_cesm585, "Forecasted Distribution 2015 - 2039 \n CESM SSP585")
dev.copy(jpeg,
         here('results/plaice_forecast',
...
df_akplarvae_avg5_cesm585 <- data.frame(lat = df_akplarvae5$lat, 
                                        ...
                                        dist = df_akplarvae5$dist,
                                        avg_pred = rowSums(df_akplarvae5[, x])/30)
saveRDS(df_akplarvae_avg5_cesm585, file = here("data", "df_akplarvae_avg5_cesm585.rds"))

# Plot
windows(width = 6, height = 6, family = "serif")
grid_predict(df_akplarvae_avg5_cesm585, "Forecasted Distribution 2040 - 2069 \n CESM SSP585")
dev.copy(jpeg,
         here('results/plaice_forecast',
...
df_akplarvae_avg6_cesm585 <- data.frame(lat = df_akplarvae6$lat, 
                                        ...
                                        dist = df_akplarvae6$dist,
                                        avg_pred = rowSums(df_akplarvae6[, x])/30)
saveRDS(df_akplarvae_avg6_cesm585, file = here("data", "df_akplarvae_avg6_cesm585.rds"))

# Plot
windows(width = 6, height = 6, family = "serif")
grid_predict(df_akplarvae_avg6_cesm585, "Forecasted Distribution 2070 - 2099 \n CESM SSP585")
dev.copy(jpeg,
         here('results/plaice_forecast',
...
df_akplarvae_avg4_gfdl585 <- data.frame(lat = df_akplarvae4$lat, 
                                        ...
                                        dist = df_akplarvae4$dist,
                                        avg_pred = rowSums(df_akplarvae4[, x])/25)
saveRDS(df_akplarvae_avg4_gfdl585, file = here("data", "df_akplarvae_avg4_gfdl585.rds"))

# Plot
windows(width = 6, height = 6, family = "serif")
grid_predict(df_akplarvae_avg4_gfdl585, "Forecasted Distribution 2015 - 2039 \n GFDL SSP585")
dev.copy(jpeg,
         here('results/plaice_forecast',
...
df_akplarvae_avg5_gfdl585 <- data.frame(lat = df_akplarvae5$lat, 
                                        ...
                                        dist = df_akplarvae5$dist,
                                        avg_pred = rowSums(df_akplarvae5[, x])/30)
saveRDS(df_akplarvae_avg5_gfdl585, file = here("data", "df_akplarvae_avg5_gfdl585.rds"))

# Plot
windows(width = 6, height = 6, family = "serif")
grid_predict(df_akplarvae_avg5_gfdl585, "Forecasted Distribution 2040 - 2069 \n GFDL SSP585")
dev.copy(jpeg,
         here('results/plaice_forecast',
...
df_akplarvae_avg6_gfdl585 <- data.frame(lat = df_akplarvae6$lat, 
                                        ...
                                        dist = df_akplarvae6$dist,
                                        avg_pred = rowSums(df_akplarvae6[, x])/30)
saveRDS(df_akplarvae_avg6_gfdl585, file = here("data", "df_akplarvae_avg6_gfdl585.rds"))

# Plot
windows(width = 6, height = 6, family = "serif")
grid_predict(df_akplarvae_avg6_gfdl585, "Forecasted Distribution 2070 - 2099 \n GFDL SSP585")
dev.copy(jpeg,
         here('results/plaice_forecast',
...
df_akplarvae_avg4_miroc585 <- data.frame(lat = df_akplarvae4$lat, 
                                         ...
                                         dist = df_akplarvae4$dist,
                                         avg_pred = rowSums(df_akplarvae4[, x])/25)
saveRDS(df_akplarvae_avg4_miroc585, file = here("data", "df_akplarvae_avg4_miroc585.rds"))

# Plot
windows(width = 6, height = 6, family = "serif")
grid_predict(df_akplarvae_avg4_miroc585, "Forecasted Distribution 2015 - 2039 \n MIROC SSP585")
dev.copy(jpeg,
         here('results/plaice_forecast',
...
df_akplarvae_avg5_miroc585 <- data.frame(lat = df_akplarvae5$lat, 
                                         ...
                                         dist = df_akplarvae5$dist,
                                         avg_pred = rowSums(df_akplarvae5[, x])/30)
saveRDS(df_akplarvae_avg5_miroc585, file = here("data", "df_akplarvae_avg5_miroc585.rds"))

# Plot
windows(width = 6, height = 6, family = "serif")
grid_predict(df_akplarvae_avg5_miroc585, "Forecasted Distribution 2040 - 2069 \n MIROC SSP585")
dev.copy(jpeg,
         here('results/plaice_forecast',
...
df_akplarvae_avg6_miroc585 <- data.frame(lat = df_akplarvae6$lat, 
                                         ...
                                         dist = df_akplarvae6$dist,
                                         avg_pred = rowSums(df_akplarvae6[, x])/30)
saveRDS(df_akplarvae_avg6_miroc585, file = here("data", "df_akplarvae_avg6_miroc585.rds"))

# Plot
windows(width = 6, height = 6, family = "serif")
grid_predict(df_akplarvae_avg6_miroc585, "Forecasted Distribution 2070 - 2099 \n MIROC SSP585")
dev.copy(jpeg,
         here('results/plaice_forecast',
...
windows(width = 6, height = 6, family = "serif")
grid_predict(df_akpegg_final1, "Forecasted Distribution 2015 - 2039")
dev.copy(jpeg,
         here('results/plaice_forecast',
              'plaice_egg_avg1.jpg'),
         height = 6,
...
windows(width = 6, height = 6, family = "serif")
grid_predict(df_akplarvae_final1, "Forecasted Distribution 2015 - 2039")
dev.copy(jpeg,
         here('results/plaice_forecast',
...
windows(width = 6, height = 6, family = "serif")
grid_predict(df_akpegg_final2, "Forecasted Distribution 2040 - 2069")
dev.copy(jpeg,
         here('results/plaice_forecast',
              'plaice_egg_avg2.jpg'),
         height = 6,
...
windows(width = 6, height = 6, family = "serif")
grid_predict(df_akplarvae_final2, "Forecasted Distribution 2040 - 2069")
dev.copy(jpeg,
         here('results/plaice_forecast',
...
windows(width = 6, height = 6, family = "serif")
grid_predict(df_akpegg_final3, "Forecasted Distribution 2070 - 2099")
dev.copy(jpeg,
         here('results/plaice_forecast',
              'plaice_egg_avg3.jpg'),
         height = 6,
...
windows(width = 6, height = 6, family = "serif")
grid_predict(df_akplarvae_final3, "Forecasted Distribution 2070 - 2099")
dev.copy(jpeg,
         here('results/plaice_forecast',

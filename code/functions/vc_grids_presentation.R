...
vc_grids_presentation <- function(data, gam_list){
  ...
  spatial_grid$pred <- predict(gam_list[[2]], newdata = spatial_grid, type = "response")
  spatial_grid$se <- predict(gam_list[[2]], newdata = spatial_grid, se = T, type = "response")[[2]]
  ...
  spatial_grid$pred2 <- predict(gam_list[[2]], newdata = spatial_grid, type = "response")
  spatial_grid$se2 <- predict(gam_list[[2]], newdata = spatial_grid, se = T, type = "response")[[2]]

...
distribution_change(pk_egg,
                    pkegg_vcgrids_t)
plot_variable_new(pklarvae_gams_t,
                  covariate = 2,
                  ybounds = c(-6, 8),
                  xbounds = c(min(pk_egg$doy),
                              max(pk_egg$doy)),
                  "Day of Year",
                  "Species Abundance Anomalies",
                  "s")
plot_variable_new(pklarvae_gams_t,
                  covariate = 4,
                  ybounds = c(-6, 8),
                  xbounds = c(min(pk_larvae$roms_temperature),
...
distribution_change(fhs_larvae,
                    fhslarvae_vcgrids_t)
plot_variable_new(akpegg_gams_t,
                  covariate = 2,
                  ybounds = c(-4, 4),
                  xbounds = c(min(akp_egg$doy),
                              max(akp_larvae$doy)),
                  "Day of Year",
                  "Species Abundance Anomalies",
                  "s")
plot_variable_new(akpegg_gams_t,
                  covariate = 4,
                  ybounds = c(-4, 4),
                  xbounds = c(min(akp_larvae$roms_temperature),
                              max(akp_egg$roms_temperature)),
                  expression(paste("Temperature ("^0, 'C)')),
                  " ",
                  "n")
plot_variable(akpegg_gams_t,
...
distribution_change(akp_egg,
                    akpegg_vcgrids_t)
plot_variable_new(akplarvae_gams_t,
                  covariate = 2,
                  ybounds = c(-4, 4),
                  xbounds = c(min(akp_egg$doy),
                              max(akp_larvae$doy)),

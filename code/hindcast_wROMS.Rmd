...
par(mfrow = c(1, 3), 
    mai = c(0.7, 0.6, 0.4, 0.4),
    family = "serif")
map_vc(pk_egg, pkegg_gams_t[[2]], pkegg_vcgrids_t, "Spatial GAM hindcast")
legend(50,
       6,
       legend = c('Mean SST', '+ 1C'),
       col = c('#000000', '#E69F00'),
...
AIC(pklarvae_gams_t[[1]][[2]]) #32677
AIC(pklarvae_gams_t[[1]][[3]]) #32605
summary(pklarvae_gams_t[[2]]) # best model is spatial, retain all smooth terms
AIC(pklarvae_gams_t[[1]][[1]]) - AIC(pklarvae_gams_t[[2]]) #96.6
```
...
var_ratio_pklarvae_month_t #0.0808
...
var_ratio_pklarvae_space_t #0.0960
```
...
AIC(fhsegg_gams_t[[1]][[2]]) # 10053
AIC(fhsegg_gams_t[[1]][[3]]) # 10046
summary(fhsegg_gams_t[[2]]) # best model is spatial VC, remove salinity
AIC(fhsegg_gams_t[[1]][[1]]) - AIC(fhsegg_gams_t[[2]]) #43.5
```
...
AIC(fhslarvae_gams_t[[1]][[1]]) #22870
AIC(fhslarvae_gams_t[[1]][[2]]) #21869
AIC(fhslarvae_gams_t[[1]][[3]]) #21874
summary(fhslarvae_gams_t[[2]]) # best model is doy VC, keep all smooth terms
AIC(fhslarvae_gams_t[[1]][[1]]) - AIC(fhslarvae_gams_t[[2]]) #1001.6
```
...
AIC(yfsegg_gams_t[[1]][[1]]) - AIC(yfsegg_gams_t[[2]]) #-1.1
```
...
AIC(yfslarvae_gams_t[[1]][[2]]) # 8459
AIC(yfslarvae_gams_t[[1]][[3]]) # 8395
summary(yfslarvae_gams_t[[2]]) # best is spatial VC, keep all smooth terms
AIC(yfslarvae_gams_t[[1]][[1]]) - AIC(yfslarvae_gams_t[[2]]) # 115.9
```
...
AIC(akplarvae_gams_t[[1]][[2]]) # 5915
AIC(akplarvae_gams_t[[1]][[3]]) # 5922
summary(akplarvae_gams_t[[2]]) # best is phenology VC
AIC(akplarvae_gams_t[[1]][[1]]) - AIC(akplarvae_gams_t[[2]]) #115.7
```

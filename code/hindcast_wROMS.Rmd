...
ratio_fhslarvae_phenology_t # 0.30
...
ratio_fhslarvae_geography_t # 0.37
```
...
AIC(akp_larvae_base_t) - AIC(akplarvae_gams_t[[2]]) # 409
...
AIC(pcod_larvae_base_t) - AIC(pcodlarvae_gams_t[[2]]) # 198
...
Create prediction grid to compare with projections
```{r}
pcod_larvae_temps <- scale_temp(pcodlarvae_gams_t, pcod_larvae)

...
```{r}
pk_egg_hindcast <- hindcast_pred(pk_egg, 5, 134, pkegg_gams_t)
...
Create prediction grid to compare with projections
```{r}
pk_larvae_hindcast <- hindcast_pred(pk_larvae, 5, 134, pklarvae_gams_t)
...
Create prediction grid to compare with projections
```{r}
fhs_egg_hindcast <- hindcast_pred(fhs_egg, 6, 154, fhsegg_gams_t)
...
Create prediction grid to compare with projections
```{r}
fhs_larvae_hindcast <- hindcast_pred(fhs_larvae, 5, 138, fhslarvae_gams_t)
...
Create prediction grid to compare with projections
```{r}
yfs_larvae_hindcast <- hindcast_pred(yfs_larvae, 9, 254, yfslarvae_gams_t)
...
Create prediction grid to compare with projections
```{r}
akp_egg_hindcast <- hindcast_pred(akp_egg, 5, 134, akpegg_gams_t)
...
Create prediction grid to compare with projections
```{r}
akp_larvae_hindcast <- hindcast_pred(akp_larvae, 5, 140, akplarvae_gams_t)
...
Create prediction grid to compare with projections
```{r}
pcod_larvae_hindcast <- hindcast_pred(pcod_larvae, 5, 134, pcodlarvae_gams_t)
...
Create prediction grid to compare with projections
```{r}
nrs_larvae_hindcast <- hindcast_pred(nrs_larvae, 5, 134, nrslarvae_gams_t)

...
# Best model by AIC is model 2
par(mfrow = c(2, 2))
plot(pk_egg_month5_t, select = 1, main = "DOY")
plot(pk_egg_month5_t, select = 4, main = "Temperature")
plot(pk_egg_month5_t, select = 5, main = "Salinity")
plot(pk_egg_month5_t, select = 6, main = "DOY by Mean ROMS SST")
...
```{r}
par(mfrow = c(2, 2))
plot(pk_egg_space2_t, select = 1, main = "DOY")
plot(pk_egg_space2_t, select = 4, main = "Temperature")
plot(pk_egg_space2_t, select = 5, main = "Salinity")
plot(pk_egg_space2_t, select = 6, main = "Location by Mean ROMS SST")
...
grid_vc_eggpk_t$pred <- predict(pk_egg_space2_t, newdata = grid_vc_eggpk_t)
grid_vc_eggpk_t$se <- predict(pk_egg_space2_t, newdata = grid_vc_eggpk_t, se = T)[[2]]
...
grid_vc_eggpk_t$pred2 <- predict(pk_egg_space2_t, newdata = grid_vc_eggpk_t)
grid_vc_eggpk_t$se2 <- predict(pk_egg_space2_t, newdata = grid_vc_eggpk_t, se = T)[[2]]
...
grid_vc_eggpk2_t <-  data.frame('lon' = rep(-170, 100),
                           ...
                           'roms_temperature' = rep(mean(pk_egg$roms_temperature, na.rm = T), 100),
                           'roms_salinity' = rep(mean(pk_egg$roms_salinity, na.rm = T), 100))
grid_vc_eggpk2_t$pred <- predict(pk_egg_month5_t, newdata = grid_vc_eggpk2_t)
grid_vc_eggpk2_t$se <- predict(pk_egg_month5_t, newdata = grid_vc_eggpk2_t, se = T)[[2]]
...
grid_vc_eggpk2_t$pred2 <- predict(pk_egg_month5_t, newdata = grid_vc_eggpk2_t)
grid_vc_eggpk2_t$se2 <- predict(pk_egg_month5_t, newdata = grid_vc_eggpk2_t, se = T)[[2]]
...
```{r}
# Use the original presence model from before
var_ratio_fhsegg_month_t <- (summary(fhs_egg_base)$scale - 
                         summary(fhs_egg_month2_t)$scale) / summary(fhs_egg_base)$scale
var_ratio_fhsegg_month_t 

var_ratio_fhsegg_space_t <- (summary(fhs_egg_base)$scale - 
                         summary(fhs_egg_space1_t)$scale) / summary(fhs_egg_base)$scale
...
grid_fhsegg_avg_t$pred <- predict(fhs_egg_base, newdata = grid_fhsegg_avg_t)
...
grid_fhsegg_avg_t2 <-  data.frame('lon' = rep(-170, 100),
                                ...
                                'doy' = seq(min(fhs_egg$doy), 
                                            ...
                                            length = 100),
                                'year' = rep(2014, 100))
grid_fhsegg_avg_t2$pred <- predict(fhs_egg_base, newdata = grid_fhsegg_avg_t2)
grid_fhsegg_avg_t2$se <- predict(fhs_egg_base, newdata = grid_fhsegg_avg_t2, se = T)[[2]]
...
par(mfrow = c(1, 2), 
    mai = c(0.8, 0.9, 0.5, 0.5),
    family = "serif")
map_vc(fhs_egg, grid_vc_eggfhs_t, grid_vc_eggfhs2_t)
  legend(140,
         11,
         legend = c('Mean SST', '+ 1C'),
         col = c('#000000', '#E69F00'),

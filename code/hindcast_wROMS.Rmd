...
```{r}
test <- visreg::visreg(pklarvae_gams_t[[2]],
                       type = "contrast", plot = FALSE, data = pk_larvae)
smooths <- plyr::ldply(test, function(part)
...
ggplot(temp_smooth, aes(x, smooth)) + geom_line() +
  geom_line(aes(y=lower), linetype="dashed") + 
  geom_line(aes(y=upper), linetype="dashed")
# want values above 0 but also above CI
```

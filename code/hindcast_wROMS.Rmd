...
pk_larvae_hindcast$temperature <- ifelse(between(pk_larvae_hindcast$temperature, 
                                                 min(pk_larvae_temps$x),
                                                 max(pk_larvae_temps$x)), 1, 0) # check to make sure this is continuous
saveRDS(pk_larvae_temps, here('data', 'pk_larvae_temps'))
...
AIC(fhsegg_gams_t[[1]][[1]]) # 14765
AIC(fhsegg_gams_t[[1]][[2]]) # 14709
AIC(fhsegg_gams_t[[1]][[3]]) # 14603
summary(fhsegg_gams_t[[2]]) # best model is spatial VC
AIC(fhsegg_gams_t[[1]][[1]]) - AIC(fhsegg_gams_t[[2]]) # 162
...
var_ratio_fhsegg_month_t #0.09

var_ratio_fhsegg_space_t <- (summary(fhs_egg_base_t)$scale - 
                         summary(fhsegg_gams_t[[1]][[3]])$scale) / summary(fhs_egg_base_t)$scale
var_ratio_fhsegg_space_t #0.12
```

Create prediction grid to compare with projections
```{r}
fhs_egg_temps <- scale_temp(fhsegg_gams_t, fhs_egg)
fhs_egg_hindcast <- hindcast_loop(1988:2014, fhs_egg, 6, 154, fhsegg_gams_t, roms_temps)
fhs_egg_hindcast$temperature <- ifelse(between(fhs_egg_hindcast$temperature, 
                                                 min(fhs_egg_temps$x),
                                                 max(fhs_egg_temps$x)), 1, 0) # check to make sure this is continuous
saveRDS(fhs_egg_temps, here('data', 'fhs_egg_temps'))
...
AIC(fhslarvae_gams_t[[1]][[1]]) #10223
AIC(fhslarvae_gams_t[[1]][[2]]) #9978
AIC(fhslarvae_gams_t[[1]][[3]]) #9778
summary(fhslarvae_gams_t[[2]]) # best model is spatial VC, keep all smooth terms
AIC(fhslarvae_gams_t[[1]][[1]]) - AIC(fhslarvae_gams_t[[2]]) # 445
...
fhs_larvae_hindcast <- hindcast_loop(1988:2014, fhs_larvae, 5, 138, fhslarvae_gams_t, roms_temps)
fhs_larvae_hindcast$temperature <- ifelse(between(fhs_larvae_hindcast$temperature, 
                                                 min(fhs_larvae_temps$x),
                                                 max(fhs_larvae_temps$x)), 1, 0) # check to make sure this is continuous
saveRDS(fhs_larvae_temps, here('data', 'fhs_larvae_temps'))
...
var_ratio_fhslarvae_month_t #0.35
...
var_ratio_fhslarvae_space_t #0.41
```
...
yfs_larvae_hindcast$temperature <- ifelse(between(yfs_larvae_hindcast$temperature, 
                                                 min(yfs_larvae_temps$x),
                                                 max(yfs_larvae_temps$x)), 1, 0) # check to make sure this is continuous
saveRDS(yfs_larvae_temps, here('data', 'yfs_larvae_temps'))
...
akp_egg_hindcast$temperature <- ifelse(between(akp_egg_hindcast$temperature, 
                                                 min(akp_egg_temps$x),
                                                 max(akp_egg_temps$x)), 1, 0) # check to make sure this is continuous
saveRDS(akp_egg_temps, here('data', 'akp_egg_temps'))
...
akp_larvae_hindcast$temperature <- ifelse(between(akp_larvae_hindcast$temperature, 
                                                 min(akp_larvae_temps$x),
                                                 max(akp_larvae_temps$x)), 1, 0) # check to make sure this is continuous
saveRDS(akp_larvae_temps, here('data', 'akp_larvae_temps'))
...
pcod_larvae_hindcast$temperature <- ifelse(between(pcod_larvae_hindcast$temperature, 
                                                 min(pcod_larvae_temps$x),
                                                 max(pcod_larvae_temps$x)), 1, 0)
saveRDS(pcod_larvae_temps, here('data', 'pcod_larvae_temps'))
...
nrs_larvae_hindcast$temperature <- ifelse(between(nrs_larvae_hindcast$temperature, 
                                                 min(nrs_larvae_temps$x),
                                                 max(nrs_larvae_temps$x)), 1, 0)
saveRDS(nrs_larvae_temps, here('data', 'nrs_larvae_temps'))

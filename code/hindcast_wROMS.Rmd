...
Create NCEP equivalent SST value from ROMS
...
var_ratio_pk_month <- (summary(pk_egg_base)$scale - summary(pk_egg_month)$scale) / 
  summary(pk_egg_base)$scale
...
# Use the original presence model from before
var_ratio_pk_space <- (summary(pk_egg_base)$scale - summary(pk_egg_space)$scale) / 
  summary(pk_egg_base)$scale

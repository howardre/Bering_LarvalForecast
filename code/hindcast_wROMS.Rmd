...
AIC(pkegg_gams_t[[1]][[1]]) - AIC(pkegg_gams_t[[1]][[3]]) # 255                    
```
...
AIC(pklarvae_gams_t[[1]][[1]]) - AIC(pklarvae_gams_t[[2]]) #273
```
...
summary(fhslarvae_gams_t[[2]]) # best model is temporal VC, keep all smooth terms
...
summary(akplarvae_gams_t[[2]]) # best is temporal VC

...
```{r}
fhs_egg <- variable_coefficient(fhsegg_gams_t, fhs_egg)

vis.gam(fhsegg_gams_t[[2]],
        view = c('lon', 'lat'),
        plot.type = "contour",
        color = "gray",
        too.far = 0.07,
        ...
        ylab = 'Latitude',
        xlab = 'Longitude')
symbols(fhs_egg$lon[fhs_egg$sign_slope_pos > 0],
        fhs_egg$lat[fhs_egg$sign_slope_pos > 0],
        circle = fhs_egg$pred_slope[fhs_egg$sign_slope_pos > 0], # not sure this is correct
        inches = 0.08,
        add = T,
        bg = alpha('darkred', 0.4),
        fg = alpha('black', 0.08))
# symbols(fhs_egg$lon[fhs_egg$sign_slope_neg],
#         fhs_egg$lat[fhs_egg$sign_slope_neg],
#         circle = (-1) * fhs_egg$pred_slope[fhs_egg$sign_slope_neg],
#         inches = 0.08,
#         add = T,
#         bg = alpha('darkslateblue', 0.4),
#         fg = alpha('black', 0.08))
...
ratio_pcodlarvae_phenology_t # 0.132
...
ratio_pcodlarvae_geography_t # 0.554
```
...
AIC(pcodlarvae_gams_t[[1]][[1]]) # 5768
AIC(pcodlarvae_gams_t[[1]][[2]]) # 5654
AIC(pcodlarvae_gams_t[[1]][[3]]) # 5660
summary(pcodlarvae_gams_t[[2]]) # best is phenology VC
AIC(pcodlarvae_gams_t[[1]][[1]]) - AIC(pcodlarvae_gams_t[[2]]) #114.1
```
...
var_ratio_pcodlarvae_month_t # 0.169
...
var_ratio_pcodlarvae_space_t # 0.166
```

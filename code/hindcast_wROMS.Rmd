...
# Best model by AIC is model 2
par(mfrow = c(2, 2))
plot(pk_larvae_month2_t, select = 1, main = "DOY")
plot(pk_larvae_month2_t, select = 3, main = "Temperature")
plot(pk_larvae_month2_t, select = 4, main = "Salinity")
plot(pk_larvae_month2_t, select = 5, main = "DOY by Mean ROMS SST")
...
```{r}
par(mfrow = c(2, 2))
plot(pk_larvae_space1_t, select = 1, main = "DOY")
plot(pk_larvae_space1_t, select = 3, main = "Temperature")
plot(pk_larvae_space1_t, select = 4, main = "Salinity")
plot(pk_larvae_space1_t, select = 5, main = "Location by Mean ROMS SST")
...
# Use the original presence model from before
var_ratio_pklarvae_month <- (summary(pk_larvae_base)$scale - 
                         summary(pk_larvae_month2_t)$scale) / summary(pk_larvae_base)$scale
var_ratio_pklarvae_month 

var_ratio_pklarvae_space <- (summary(pk_larvae_base)$scale - 
                         summary(pk_larvae_space1_t)$scale) / summary(pk_larvae_base)$scale
var_ratio_pklarvae_space
```
...
grid_pklarvae_avg_t$pred <- predict(pk_larvae_base, newdata = grid_pklarvae_avg_t)
...
grid_pklarvae_avg_t2 <-  data.frame('lon' = rep(-170, 100),
                                ...
                                'doy' = seq(min(pk_larvae$doy), 
                                            ...
                                            length = 100),
                                'year' = rep(2014, 100))
grid_pklarvae_avg_t2$pred <- predict(pk_larvae_base, newdata = grid_pklarvae_avg_t2)
grid_pklarvae_avg_t2$se <- predict(pk_larvae_base, newdata = grid_pklarvae_avg_t2, se = T)[[2]]
...
grid_vc_larvaepk_t$pred <- predict(pk_larvae_space1_t, newdata = grid_vc_larvaepk_t)
grid_vc_larvaepk_t$se <- predict(pk_larvae_space1_t, newdata = grid_vc_larvaepk_t, se = T)[[2]]
...
grid_vc_larvaepk_t$pred2 <- predict(pk_larvae_space1_t, newdata = grid_vc_larvaepk_t)
grid_vc_larvaepk_t$se2 <- predict(pk_larvae_space1_t, newdata = grid_vc_larvaepk_t, se = T)[[2]]
...
grid_vc_larvaepk2_t <-  data.frame('lon' = rep(-170, 100),
                           ...
                           'roms_temperature' = rep(mean(pk_larvae$roms_temperature, na.rm = T), 100),
                           'roms_salinity' = rep(mean(pk_larvae$roms_salinity, na.rm = T), 100))
grid_vc_larvaepk2_t$pred <- predict(pk_larvae_month2_t, newdata = grid_vc_larvaepk2_t)
grid_vc_larvaepk2_t$se <- predict(pk_larvae_month2_t, newdata = grid_vc_larvaepk2_t, se = T)[[2]]
...
grid_vc_larvaepk2_t$pred2 <- predict(pk_larvae_month2_t, newdata = grid_vc_larvaepk2_t)
grid_vc_larvaepk2_t$se2 <- predict(pk_larvae_month2_t, newdata = grid_vc_larvaepk2_t, se = T)[[2]]
